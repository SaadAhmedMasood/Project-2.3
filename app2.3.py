...
#---------------------------2nd Part End here--------------------------------#
#For report download in PDF format
...
# ... (previous code for Streamlit app) ...
...
def generate_pdf_report():
    ...
    c.drawString(100, 750, "Car Purchase Decision Report")
    
    # Add user preferences to the report
    c.drawString(100, 720, "User Preferences:")
    user_prefs_str = user_prefs.to_string(index=False)
    c.drawString(100, 700, user_prefs_str)

    # Add a section for data visualization
    c.drawString(100, 650, "Data Visualization:")

    # Create a scatterplot of price vs. fuel efficiency
    ...
    c.drawString(100, 620, "Price vs. Fuel Efficiency:")
    c.drawImage("scatterplot.png", 100, 420, width=400, height=250)

    # Add a table for car recommendations
    c.drawString(100, 350, "Car Recommendations:")
    recommendations_table = filtered_data[["Manufacturer", "Model", "Price_in_thousands", "Fuel_efficiency"]].head(5)
    recommendations_table_str = recommendations_table.to_string(index=False)
    c.drawString(100, 330, recommendations_table_str)
    ...
    pdf_buffer.seek(0)
    st.download_button("Download PDF Report", pdf_buffer.getvalue(), "car_purchase_report.pdf")
